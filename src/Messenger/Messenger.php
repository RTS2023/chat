...
use DB;
use App;
use Messenger\Exceptions\MessengerException;
use Messenger\Contracts\MessageableInterface;
use Messenger\Contracts\MessageThreadInterface;
...
class Messenger
{
     ...
     * Send message.
     *
     * @return Messenger\Contracts\MessageInterface
     */
     ...
     * found, create one.
     *
     * @return Messenger\Models\MessageThread
     */
